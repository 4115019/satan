...
public class AbccSingleTrade {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int i = 0;
        BigDecimal lastPrice = new BigDecimal("0.7654"), lastSuccessPrice = new BigDecimal("0.7654");
        ...
        while (++i > 0) {
            ...
            lastPrice = ask1Price.compareTo(lastSuccessPrice) > 0 ? ask1Price : lastSuccessPrice.add(PRICE_RAISE).setScale(4, BigDecimal.ROUND_DOWN);
