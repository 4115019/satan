package com.satan.trade.common.web.result;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.alibaba.fastjson.serializer.SerializeConfig;
import com.alibaba.fastjson.serializer.SerializeFilter;
import com.satan.trade.common.annotation.IPropertyFilter;
import com.satan.trade.common.annotation.JSONPropertyFilter;
import com.satan.trade.common.exception.IErrorCode;
import com.satan.trade.common.fastjson.BigDecimalFilter;
import com.satan.trade.common.fastjson.DateValueFilter;
import com.satan.trade.common.fastjson.FastJsonUpperCaseTo_;
...
public class JSONResult extends Result<JSONObject> {
    ...
    private static String toJSONString(Object object, IPropertyFilter propertyFilter, String dateFormat, SerializeConfig config) {
        ...
        if (propertyFilter == null) {
            filters = new SerializeFilter[]{new FastJsonUpperCaseTo_(), new DateValueFilter(), new BigDecimalFilter()};
        } else {
            filters = new SerializeFilter[]{new JSONPropertyFilter(propertyFilter), new FastJsonUpperCaseTo_(), new DateValueFilter(), new BigDecimalFilter()};
        }
        if (object == null) {
